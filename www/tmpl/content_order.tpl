        ...
        <table>
            ...
            <tr>
                <td class="button">
                    ...
                    <input type="image" src="images/order.png" alt="Закончить оформление заказа" onmouseover="this.src = 'images/order_active.png'" onmouseout="this.src = 'images/order.png'"/>
                </td>
            </tr>
        </table>
    </form>
